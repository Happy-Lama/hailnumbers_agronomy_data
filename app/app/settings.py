...
DATABASES = {
    ...
    'default': dj_database_url.config(
        default="postgres://hailnumbers_postgresql_user:dt0sLapI5S61ocr61e7rJrcPNTUy0zPk@dpg-cnula263e1ms73cpcc40-a.oregon-postgres.render.com/hailnumbers_postgresql",
        conn_max_age=600
    )
}
